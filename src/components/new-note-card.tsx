...
export function NewNoteCard() {
  ...
  function handleContentsChanged(event: ChangeEvent<HTMLTextAreaElement>) {
            ...
            <form onSubmit={handleSaveNote} className="flex-1 flex flex-col">
              <div className="flex flex-1 flex-col gap-3 p-5">
                ...
                {shouldShowOnboarding ? (
                  ...
                  <textarea
                    autoFocus
                    className="text-sm leading-6 text-slate-400 bg-transparent reszise-none flex-1 outline-none"
